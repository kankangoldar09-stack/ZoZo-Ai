    ...
    const start = async () => {
        ...
        const session = ai.live.connect({
            ...
            config: {
                ...
                वर्तमान समय और तारीख (Current Date & Time): ${new Date().toLocaleString('en-IN')} (India Standard Time)
                वर्ष (Current Year): ${new Date().getFullYear()}
                ...
                **भावनाओं का मिलान (Emotion Mirroring)**: यदि उपयोगकर्ता उदास (sad), निराश या कम ऊर्जा महसूस कर रहा है, तो उसके प्रति गहरी सहानुभूति और संवेदनशीलता दिखाएं। ऐसे समय में मज़ाक या मज़ाकिया बातें न करें। अपनी आवाज़ को अत्यंत शांत, गंभीर और ढांढस बंधाने वाली रखें ताकि उसे महसूस हो कि आप उसके दुःख को सच में समझते हैं।`
            }
        });
